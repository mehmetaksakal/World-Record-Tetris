/***********************************************************************
 * $Id:: CAN_Node_Def.h 1604 2014-07-14 11:34:473     $
 *
...
#define CAN_NODE_ID				CAN_SLAVE1_NODE		/* CAN Node ID */
...
extern uint8_t  LED1;									/* LEDcube 1 of node */
extern uint8_t  LED2;									/* LEDcube 2 of node */
extern uint8_t  LED3;									/* LEDcube 3 of node */
extern uint8_t  LED4;									/* LEDcube 4 of node */
extern uint8_t	HighVoltage;							/* HighVoltage check */
extern uint8_t	ADCValue_MSB;							/* LowVoltage value */
extern uint8_t	ADCValue_LSB;							/* LowVoltage value */
